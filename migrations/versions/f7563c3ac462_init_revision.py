...
Revision ID: f7563c3ac462
Revises: 
Create Date: 2023-09-14 23:14:39.146798
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['manufacturer_id'], ['manufactures.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('pet_owner_association',
    sa.Column('owner_id', sa.UUID(), nullable=False),
    sa.Column('pet_id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['owner_id'], ['clients.id'], ),
    sa.ForeignKeyConstraint(['pet_id'], ['pets.id'], ),
    sa.PrimaryKeyConstraint('owner_id', 'pet_id')
    )
...
def downgrade() -> None:
    ...
    op.drop_table('pet_owner_association')
